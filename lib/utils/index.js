...
module.exports = {
	...
	/**
     * Takes Object as parameter and return an array
		 * containing the given object, or an empty array if object was null
     */
    ...
    */
	...
	getModelUniqueKey: function(model) {
		...
		var pk = _.filter(model, function(o) {
			return o.primaryKey === true;
		});
		if (!(pk && pk.length)) {
			pk = _.filter(model, function(o) {
