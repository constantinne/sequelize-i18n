...
Sequelize_i18n.prototype.getI18nModel = function(model_name) {
	var model = _.filter(this.i18n_models, function(o) {
		return o.target.name == model_name;
	});
 ...
 */
Sequelize_i18n.prototype.createI18nModel = function(
	name,
	attributes,
	options,
	base_model_name
...
Sequelize_i18n.prototype.setInstanceMethods = function(
	instance_methods,
	_i18n_modelName
) {
